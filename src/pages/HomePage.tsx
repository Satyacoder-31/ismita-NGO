...
export const HomePage: React.FC = () => {
  return (
    <div className="space-y-20 sm:space-y-28 pb-16">
      ...
      <section className="max-w-[1720px] mx-auto px-6 sm:px-8 lg:px-12 xl:px-16 -mt-12 sm:-mt-20 relative z-30">
      ...
      <section className="max-w-[1720px] mx-auto px-6 sm:px-8 lg:px-12 xl:px-16">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
          ...
          <div className="group bg-white rounded-3xl p-8 border border-slate-200/80 shadow-sm hover:shadow-2xl transition-all duration-300 hover:-translate-y-1 relative overflow-hidden flex flex-col justify-between">
            ...
            <div>
              <div className="w-14 h-14 rounded-2xl bg-emerald-100 flex items-center justify-center text-[#0F3E2E] mb-6 group-hover:bg-[#0F3E2E] group-hover:text-white transition-colors">
            ...
            <div className="mt-8 pt-6 border-t border-slate-100">
              <Link
                to="/children"
                className="inline-flex items-center text-sm font-bold text-[#0F3E2E] hover:text-emerald-700 group-hover:translate-x-1 transition-transform"
              >
          ...
          <div className="group bg-white rounded-3xl p-8 border border-slate-200/80 shadow-sm hover:shadow-2xl transition-all duration-300 hover:-translate-y-1 relative overflow-hidden flex flex-col justify-between">
            ...
            <div>
              <div className="w-14 h-14 rounded-2xl bg-amber-100 flex items-center justify-center text-amber-800 mb-6 group-hover:bg-amber-600 group-hover:text-white transition-colors">
            ...
            <div className="mt-8 pt-6 border-t border-slate-100">
              <Link
                to="/old-age-care"
                className="inline-flex items-center text-sm font-bold text-amber-800 hover:text-amber-700 group-hover:translate-x-1 transition-transform"
              >
          ...
          <div className="group bg-white rounded-3xl p-8 border border-slate-200/80 shadow-sm hover:shadow-2xl transition-all duration-300 hover:-translate-y-1 relative overflow-hidden flex flex-col justify-between">
            ...
            <div>
              <div className="w-14 h-14 rounded-2xl bg-blue-100 flex items-center justify-center text-blue-800 mb-6 group-hover:bg-blue-600 group-hover:text-white transition-colors">
            ...
            <div className="mt-8 pt-6 border-t border-slate-100">
              <Link
                to="/store"
                className="inline-flex items-center text-sm font-bold text-blue-800 hover:text-blue-700 group-hover:translate-x-1 transition-transform"
              >
      ...
      <section className="max-w-[1720px] mx-auto px-6 sm:px-8 lg:px-12 xl:px-16">
        <div className="bg-white rounded-3xl border border-slate-200/80 p-8 sm:p-12 lg:p-16 shadow-xl grid grid-cols-1 lg:grid-cols-12 gap-12 items-center">
          <div className="lg:col-span-6 space-y-6">
            ...
            <div className="grid grid-cols-2 gap-4 pt-2">
              <div className="flex items-start space-x-3">
                ...
                <span className="text-sm font-semibold text-slate-800">100% Free Child Education</span>
              </div>
              <div className="flex items-start space-x-3">
                <CheckCircle2 className="w-5 h-5 text-emerald-600 flex-shrink-0 mt-0.5" />
                <span className="text-sm font-semibold text-slate-800">24/7 Geriatric Doctors</span>
              </div>
              <div className="flex items-start space-x-3">
                <CheckCircle2 className="w-5 h-5 text-emerald-600 flex-shrink-0 mt-0.5" />
                <span className="text-sm font-semibold text-slate-800">80G Tax Deductible</span>
              </div>
              <div className="flex items-start space-x-3">
                <CheckCircle2 className="w-5 h-5 text-emerald-600 flex-shrink-0 mt-0.5" />
                <span className="text-sm font-semibold text-slate-800">Direct Rupee Auditing</span>
              </div>
            </div>
            ...
            <div className="pt-4 flex flex-wrap gap-4">
              <Link
                to="/about"
                className="px-6 py-3.5 bg-[#0F3E2E] hover:bg-emerald-900 text-white font-bold rounded-xl text-sm transition shadow-md"
              >
                Read Our Complete Story
              </Link>
              <Link
                to="/sponsor"
                className="px-6 py-3.5 bg-amber-50 text-amber-900 border border-amber-300 hover:bg-amber-100 font-bold rounded-xl text-sm transition"
              >
          ...
          <div className="lg:col-span-6 relative">
            ...
            <div className="absolute -bottom-6 -left-6 bg-white rounded-2xl p-5 shadow-2xl border border-slate-100 max-w-[240px] hidden sm:block">
      ...
      <section className="bg-slate-900 text-white py-20 relative overflow-hidden">
        <div className="max-w-[1720px] mx-auto px-6 sm:px-8 lg:px-12 xl:px-16 relative z-10">
          <div className="flex flex-col md:flex-row md:items-end justify-between mb-12">
            ...
            <Link
              to="/old-age-care"
              className="mt-4 md:mt-0 inline-flex items-center text-sm font-bold text-amber-400 hover:text-amber-300"
            >
      ...
      <section className="max-w-[1720px] mx-auto px-6 sm:px-8 lg:px-12 xl:px-16">
        <div className="bg-gradient-to-br from-emerald-50 via-white to-amber-50/50 rounded-3xl border border-emerald-200/80 p-8 sm:p-12 shadow-lg mb-10">
          <div className="flex flex-col md:flex-row md:items-center justify-between gap-6">
            ...
            <Link
              to="/store"
              className="px-6 py-3.5 bg-[#0F3E2E] hover:bg-emerald-900 text-white font-bold rounded-2xl text-sm transition shadow-lg flex items-center justify-center space-x-2 whitespace-nowrap"
            >
      ...
      <section className="max-w-[1720px] mx-auto px-6 sm:px-8 lg:px-12 xl:px-16">
        <div className="relative rounded-3xl overflow-hidden shadow-2xl min-h-[500px] flex items-center justify-center text-center p-8 sm:p-14">
          <div
          ...
          <div className="relative z-10 max-w-3xl space-y-6 text-white">
            <span className="px-4 py-1.5 rounded-full bg-amber-400/20 text-amber-300 text-xs font-extrabold uppercase tracking-widest border border-amber-400/30 inline-block">
              Make a Lasting Difference
            </span>
            <h2 className="text-4xl sm:text-5xl lg:text-6xl font-extrabold font-heading tracking-tight">
            ...
            <div className="flex flex-wrap justify-center gap-3.5 pt-4">
              <Link
                to="/donate"
                className="px-7 py-3.5 bg-gradient-to-r from-amber-500 to-amber-600 hover:from-amber-400 text-slate-950 font-extrabold rounded-2xl shadow-xl transition flex items-center space-x-2 text-sm sm:text-base"
              >
              ...
              <Link
                to="/sponsor"
                className="px-7 py-3.5 bg-[#0F3E2E] hover:bg-emerald-900 text-white font-bold rounded-2xl border border-emerald-600/40 transition text-sm sm:text-base"
              >
                Sponsor a Child
              </Link>
              <Link
                to="/old-age-care"
                className="px-7 py-3.5 bg-white/10 hover:bg-white/20 text-white font-bold rounded-2xl backdrop-blur-md border border-white/20 transition text-sm sm:text-base"
              >
                Support an Elder
              </Link>
              <Link
                to="/store"
                className="px-7 py-3.5 bg-emerald-600 hover:bg-emerald-500 text-white font-bold rounded-2xl transition text-sm sm:text-base flex items-center space-x-1.5"
              >
                <ShoppingBag className="w-4 h-4" />
              ...
              <Link
                to="/volunteer"
                className="px-7 py-3.5 bg-transparent hover:bg-white/10 text-slate-300 hover:text-white font-semibold rounded-2xl transition text-sm sm:text-base"
              >
                Become a Volunteer
              </Link>
            </div>
