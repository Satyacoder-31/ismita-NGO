...
export const AdminDashboardPage: React.FC = () => {
  ...
  return (
    <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-10 space-y-8">
      ...
      <div className="flex flex-col md:flex-row md:items-center justify-between bg-white p-5 sm:p-6 rounded-3xl border border-slate-200/80 shadow-sm gap-4">
        <div>
          ...
          <h1 className="text-xl sm:text-2xl lg:text-3xl font-extrabold text-slate-900 font-heading mt-1">
        ...
        <div className="flex flex-wrap items-center gap-2.5 sm:gap-3">
          <button
            ...
            className="px-3.5 sm:px-4 py-2 bg-slate-100 hover:bg-slate-200 text-slate-700 rounded-xl text-xs font-bold transition flex items-center space-x-1.5"
          >
          ...
          <Link
            to="/donate"
            className="px-3.5 sm:px-4 py-2 bg-[#0F3E2E] text-white rounded-xl text-xs font-bold hover:bg-emerald-900 transition shadow"
          >
      ...
      <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-3 sm:gap-4">
        <div className="bg-white p-4 sm:p-5 rounded-3xl border border-slate-200 shadow-sm space-y-2">
          ...
          <p className="text-xl sm:text-2xl font-black text-[#0F3E2E]">₹{(totalDonationSum + 985000).toLocaleString('en-IN')}</p>
        ...
        <div className="bg-white p-4 sm:p-5 rounded-3xl border border-slate-200 shadow-sm space-y-2">
          ...
          <p className="text-xl sm:text-2xl font-black text-slate-900">254 Students</p>
        ...
        <div className="bg-white p-4 sm:p-5 rounded-3xl border border-slate-200 shadow-sm space-y-2">
          ...
          <p className="text-xl sm:text-2xl font-black text-slate-900">64 Elders</p>
        ...
        <div className="bg-white p-4 sm:p-5 rounded-3xl border border-slate-200 shadow-sm space-y-2">
          ...
          <p className="text-xl sm:text-2xl font-black text-[#0F3E2E]">₹1,42,850</p>
          <span className="text-[11px] text-emerald-600 font-semibold">Funds 950+ student meals</span>
        </div>
      </div>

      {/* Admin Tabbed Navigation */}
      <div className="flex space-x-2 border-b border-slate-200 pb-2 overflow-x-auto no-scrollbar -mx-4 px-4 sm:mx-0 sm:px-0">
        {[
          ...
          return (
            <button
              ...
              className={`px-3.5 sm:px-4 py-2 sm:py-2.5 rounded-xl sm:rounded-2xl text-xs font-bold transition flex items-center space-x-2 whitespace-nowrap ${
                activeTab === tab.id
