      ...
      <div className="p-5 flex-1 flex flex-col justify-between">
        <div>
          ...
          <Link to={`/store/${product.id}`} className="block">
            <h3 className="font-heading font-bold text-slate-900 text-base line-clamp-2 hover:text-[#0F3E2E] transition leading-snug">
              {product.name}
            </h3>
          </Link>
          ...
          <div className="mt-3 flex items-baseline space-x-2">
            <span className="text-xl font-extrabold text-[#0F3E2E]">₹{product.price}</span>
          ...
          {/* Social Impact Note */}
          <div className="mt-3 bg-emerald-50/70 border border-emerald-100 rounded-xl p-2.5 text-[11.5px] text-emerald-900 flex items-start space-x-2">
        ...
        <div className="grid grid-cols-2 gap-2 mt-4 pt-3 border-t border-slate-100">
          <button
            ...
            className={`py-2 px-3 rounded-xl text-xs font-bold flex items-center justify-center space-x-1 transition shadow-sm ${
              added
          ...
          <button
            ...
            disabled={!product.inStock}
            className="py-2 px-3 bg-[#0F3E2E] hover:bg-emerald-900 text-white rounded-xl text-xs font-bold transition shadow-sm hover:shadow text-center"
          >
            Buy Now
          </button>
        </div>
